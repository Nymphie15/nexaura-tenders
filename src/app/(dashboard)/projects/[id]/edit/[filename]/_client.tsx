...
export default function EditProjectDocumentPage() {
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b bg-muted/20">
        ...
        <div className="flex items-center gap-3">
          {autoSaveStatus === "saving" && (
            <Badge variant="secondary" className="gap-1 text-xs bg-blue-50 text-blue-600">
              <Loader2 className="h-3 w-3 animate-spin" />
              Sauvegarde...
            </Badge>
          )}
          {autoSaveStatus === "saved" && savedText && (
            <Badge variant="secondary" className="gap-1 text-xs bg-green-50 text-green-600">
              <CheckCircle2 className="h-3 w-3" />
              {savedText}
            </Badge>
          )}
          {autoSaveStatus === "error" && (
            <Badge variant="secondary" className="gap-1 text-xs bg-red-50 text-red-600">
